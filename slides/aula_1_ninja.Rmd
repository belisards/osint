...
- **Captura de tela completa**: faça uma captura de tela que indique o dia e hora da captura em questão de algum modo. Algumas extensões de navegador podem ser úteis (exemplo: [GoFullPage](https://gofullpage.com/) ou [Screencastfy](https://www.screencastify.com/))
...
Também é possível utilizar recursos online para fazer o arquivamento de evidências, como o site [Archive.is](https://archive.is).
