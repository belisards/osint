...
- Imagens de rua: fotos do Google Maps, Street View, [Kartaview](kartaview.org)
...
1. [Checagem de imagens: cronolocalização de fotos](https://escoladedados.org/tutoriais/checagem-de-imagens-cronolocalizacao-de-fotos/) - Adriano Belisario

1. Calculate time using shadows - Bendobrown
...
[belisario.webiste/osint](belisario.webiste/osint)
