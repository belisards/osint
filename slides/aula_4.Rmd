...
- Segurança digital, uma perspectiva holística
- Navegando na web de forma anônima
- Cuidando de suas senhas
...
- [Buscador de subdomínios](https://spyse.com/tools/subdomain-finder): busca subdomínios;

- [Visual site mapper](http://visualsitemapper.com/): visualização das páginas de um site em grafo;

- [Spy On Web](https://spyonweb.com): para pesquisar sites com o mesmo código Adsense, Analytics, etc;
